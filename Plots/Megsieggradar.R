# I modified the ggradar function to do nice things that I like, like use a custom color palette, including different line types, etc.
#' ggradar
#' @author Ricardo Bion
#' @export ggradar
#'
...
ggradar <- function(plot.data,
  ...
  if(plot.legend==TRUE){
    base <- base + theme(legend.text = element_text(size = legend.text.size*3), legend.position="left") +
