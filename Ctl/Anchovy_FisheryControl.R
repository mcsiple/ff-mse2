...
init.B <- init.prop*20000 # Biomass at age -- 110.54 is the B0 when R0 = 1000 (this used to be 31... but the multiplier should be the total biomass in the first year!) - MAKE SURE THIS MATCHES THE BIOMASS OF A REAL POPULATION!
